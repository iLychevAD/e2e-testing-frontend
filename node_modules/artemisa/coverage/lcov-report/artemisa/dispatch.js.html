...
<html lang="en">
<head>
    <title>Code coverage report for artemisa/dispatch.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">artemisa</a> dispatch.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { isReceive } from '../core/actions'
...
&nbsp;
  // No key =&gt; no fetch
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!key) <span class="cstat-no" title="statement not covered" >return false</span>
&nbsp;
...
&nbsp;
  return (keyProvider || (<span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >s </span>=&gt; <span class="cstat-no" title="statement not covered" >s.value.transformerId)</span></span>)(fetchState) !== key
}</pre></td></tr>
</table></pre>
