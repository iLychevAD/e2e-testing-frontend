...
<html lang="en">
<head>
    <title>Code coverage report for core/actions.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">core</a> actions.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
export const simulateDataReceive = <span class="fstat-no" title="function not covered" >(a</span>ction, data) =&gt; <span class="cstat-no" title="statement not covered" >onReceiveActionCreator(action)(data)</span>
&nbsp;
//
// Checking
// 
...
&nbsp;
export const isDerivedActionFor = <span class="fstat-no" title="function not covered" >(a</span>ction, apiActionType) =&gt; <span class="cstat-no" title="statement not covered" >action.originType === apiActionType</span>
&nbsp;
