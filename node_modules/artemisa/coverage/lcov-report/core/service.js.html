...
<html lang="en">
<head>
    <title>Code coverage report for core/service.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">core</a> service.js
    </h1>
    <div class='clearfix'>
  ...
  return apiFetch(compileUrl(path, urlParams), fetchOptions(method, body, token))
    .then(response =&gt;
      ...
      (response.ok
        ...
        : <span class="branch-1 cbranch-no" title="branch not covered" >response.json().then(<span class="fstat-no" title="function not covered" >js</span>on =&gt; <span class="cstat-no" title="statement not covered" >next(onError(json.error.message)))</span>)</span>
    )
    .catch(error =&gt; {
